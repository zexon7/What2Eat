...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:15%">
  ...
  <b><input class="w3-bar-item w3-button w3-light-blue w3-hover-black w3-large" type="button" value="新增店家" onclick="location.href='add_v.php'"></b>
</div>
</nav>
...
<?php
	while($row_result=mysql_fetch_assoc($result)){
		...
		echo "<td><a class='w3-button w3-light-blue w3-hover-black' href='update_v.php?id=".$row_result["rNo"]."'><b>修改</b></a> ";
		echo "<a class='w3-button w3-text-black w3-red w3-hover-black' href='delete_v.php?id=".$row_result["rNo"]."'><b>刪除</b></a></td>";
		echo "</tr>";
	}
?>
</table>
