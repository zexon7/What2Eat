	...
	<table class="w3-table w3-xlarge w3-centered w3-border-black" border="1" align="center">
  	...
  	<?php
		...
		while($row=mysql_fetch_assoc($result)){
			if($row["rType"]=="葷"){
				echo "<tr><td class='w3-amber'>".$row["ROW"]."</td>";
				echo "<td class='w3-amber'>".$row["rName"]."</td>";
				echo "<td class='w3-amber'>".$row["rAddr"]."</td>";
				echo "<td class='w3-amber'>".$row["rType"]."</td>";
				echo "<td class='w3-amber'>".$row["rPrice"]."</td>";
				echo "<td class='w3-amber'>".$row["rFeature"]."</td>";
				echo "<td class='w3-amber'>".$row["ROUND(AVG(tRating),1)"]."</td></tr>";
			}
			if($row["rType"]=="素"){
				echo "<tr><td class='w3-green w3-text-black'>".$row["ROW"]."</td>";
				...
				echo "<td class='w3-green w3-text-black'>".$row["ROUND(AVG(tRating),1)"]."</td></tr>";
			}
		}
