...
if(isset($_POST["action"])&&($_POST["action"]=="add")){
	$sql_query = "INSERT INTO `vratings` (`vNo`,`vRating`) VALUES (";
	$sql_query .= "'".$_POST["vNo"]."',";	
	$sql_query .= "'".$_POST["vRating"]."')";
...
<form action="" method="post" name="formAdd" id="formAdd">
  <table class="w3-table w3-centered w3-xlarge w3-border-black" border="1" align="center" cellpadding="4">
    ...
    <tr>
      <td>店家編號</td><td><input type="text" name="vNo" id="vNo" size="2" value="<?php echo $row_result["rNo"];?>"></td>
    </tr>
    <tr>
      <td>評價</td>
      <td>
      	<input type="radio" name="vRating" id="vRating" value="1" checked>1
      	<input type="radio" name="vRating" id="vRating" value="2">2
      	<input type="radio" name="vRating" id="vRating" value="3">3
      	<input type="radio" name="vRating" id="vRating" value="4">4
      	<input type="radio" name="vRating" id="vRating" value="5">5
      </td>
    </tr>
    <tr>
      <td colspan="2" align="center">
      <input name="action" type="hidden" value="add">
      <b><input class="w3-button w3-green w3-text-black w3-hover-red" type="submit" name="button" id="button" value="評分"></b>
      </td>
    </tr>
  </table>
</form>
