...
if(isset($_POST["action"])&&($_POST["action"]=="add")){
	...
	$sql_query = "INSERT INTO `restaurants_v` (`rName` ,`rAddr` ,`rType` ,`rPrice` ,`rFeature` ,`rRating`) VALUES (";
...
<form action="" method="post" name="formAdd" id="formAdd">
  <table class="w3-table w3-centered w3-xlarge w3-border-black" border="1" align="center" cellpadding="4">
    ...
    <tr>
      <td>葷/素</td><td>
      <input type="radio" name="rType" id="rType" value="葷">葷
      <input type="radio" name="rType" id="rType" value="素" checked>素
      </td>
    </tr>
     <tr>
      <td>價位</td><td>
    ...
    <tr>
      ...
      <b><input class="w3-button w3-green w3-text-black w3-hover-red" type="submit" name="button" id="button" value="新增店家"></b>
      <b><input class="w3-button w3-green w3-text-black w3-hover-red" type="reset" name="button2" id="button2" value="重新填寫"></b>
      </td>
    </tr>
  </table>
</form>
